...
monthly_summary = pd.read_csv(
    "dashboard/dashboard_monthly_summary.csv",
    parse_dates=["order_month"]
)

category_revenue = pd.read_csv(
    "dashboard/dashboard_revenue_by_category.csv"
)

rfm_customer = pd.read_csv(
    "dashboard/dashboard_rfm_customer.csv"
)

rfm_segment_summary = pd.read_csv(
    "dashboard/dashboard_rfm_segment_summary.csv"
)
